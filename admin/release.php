...
// {
  if($image_size < 5000000){
    ...
    $query = "INSERT into release_quote (orderid,email,price,image1,stich,user) VALUES ('$orderid','$email','$price','$folder2','$stich','$user')";
...
//     $is_insert = true;
//     // header('Location: https://dashboard.selectdigitizing.com/admin/vectorrecords.php');
...
$mail->Subject = 'Your (Quote# Q-1'.$orderid.')('.$name1.') is ready';
$mail->Body = 'Dear '.$cusname.'<br>'.
'Attached are your quote files. You can also download files or send revisions
   from Quote Records after signing into your account at our website www.selectdigitizing.com
   <h2>Design Order Details:</h2><table style="border-collapse: collapse; width: 50%;"><tr><td style="border: 1px solid black; padding: 5px;">Design Name/PO</td><td style="border: 1px solid black; padding: 5px;">'.$name1.'</td></tr><tr><td style="border: 1px solid black; padding: 5px;">Required Format</td><td style="border: 1px solid black; padding: 5px;">'.$required.'</td></tr><tr><td style="border: 1px solid black; padding: 5px;">Width</td><td style="border: 1px solid black; padding: 5px;">'.$width.'</td></tr><tr><td style="border: 1px solid black; padding: 5px;">Height</td><td style="border: 1px solid black; padding: 5px;">'.$height.'</td></tr><tr><td style="border: 1px solid black; padding: 5px;">Fabric</td><td style="border: 1px solid black; padding: 5px;">'.$fabric.'</td></tr><tr><td style="border: 1px solid black; padding: 5px;">Placement</td><td style="border: 1px solid black; padding: 5px;">'.$placement.'</td></tr><tr><td style="border: 1px solid black; padding: 5px;">No of Colors</td><td style="border: 1px solid black; padding: 5px;">'.$color.'</td></tr><tr><td style="border: 1px solid black; padding: 5px;">Addtional Instructions</td><td style="border: 1px solid black; padding: 5px;">'.$ins.'</td></tr><tr><td style="border: 1px solid black; padding: 5px;">Price</td><td style="border: 1px solid black; padding: 5px;">'.$price.'</td></tr></table>
   ...
   Please do contact us if you have further questions and concerns.<br>
    ...
    URL: www.com';
    $mail->isHTML(true); // Set email content to be HTML formatted
...
//   $name = "selectdigitizing";
//     $email1 = "selectdigitizing@gmail.com";
    // $phone = "03122321752";
    // $subject = "ksdjsnd";
    // $message=  "jsbcjns";
...
//     $mail->Subject = "Your Quote".$orderid." is Ready";
//     $mail->Body = "<p>Dear ".$email."</p>
//     <p>Attached are your quote files. You can also download files or send revisions from Quote Records after signing into your account at our website www.selectdigitizing.com</p>
//     <p>Design Name/PO:".$name1."</p>
//     <p>Required Format:".$required."</p>
//     <p>Width:".$width."</p>
//     <p>Height".$height."</p>
//     <p>Fabric:".$fabric."</p>
//     <p>Placement:".$placement."</p>
//   <p>No Of Colors:".$color."</p>
//   <p>Additional Instructions:".$ins."</p>
//   <p>Price:".$price."</p>
...
echo "<script>alert('Quote release');
     window.location.href ='pending_quote.php'</script>";
