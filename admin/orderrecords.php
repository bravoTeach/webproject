...
$sql = "SELECT * FROM placeorder where status = 'release'";

$result = mysqli_query($conn, $sql);
// -------------------------------
// $sql2="SELECT * FROM placeorder where status = 'release' ORDER BY id DESC";
...
?>
<div>
<h4>Total Release Orders:  <?php echo $inquiry;  ?> </h4>
...
<td><a href="delete_order.php?id=<?= $row["id"];?>"style="background-color:blue;">DELETE</a></td>
<!-- <td><a href="quotedetail.php?id=<?= $row["id"];?>">DETAIL</a></td> -->
<!--<td><a href="release_order.php?id=<?= $row["id"];?>">RELEASE</a></td>-->
<td><a href="pdf_order.php?id=<?= $row["id"];?>"style="background-color:blue;">PDF</a></td>
