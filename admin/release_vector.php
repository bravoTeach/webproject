...
$sql2 = "SELECT * FROM placevector where id = '$id'";
...
<head>
  ...
  <title>Release Vector</title>
</head>
<body>
  <form action="release_vector.php" method="POST" enctype="multipart/form-data">
  <div class="mb-3">
 Attachment 1:
 <br>
...
$id = $_POST['id'];
    ...
    $query = "INSERT into release_vector (orderid,email,price,image1,stich,ordername,user) VALUES ('$orderid','$email','$price','$folder2','$stich','$name1','$user')";
...
$mail->Subject = "Your Vector Order# V-1".$orderid."(".$name1.") is Ready";
// $subject = "Your Order#".$orderid." is Ready";
 $mail->Body = 'Dear '.$cusname.'<br>'.
'Attached please find you Vector files. You can also download files or send revisions from Vector Records after signing into your account at our website wwwcom


   <h2>Design Order Details:</h2><table style="border-collapse: collapse; width: 50%;"><tr><td style="border: 1px solid black; padding: 5px;">Design Name/PO</td><td style="border: 1px solid black; padding: 5px;">'.$name1.'</td></tr><tr><td style="border: 1px solid black; padding: 5px;">Required Format</td><td style="border: 1px solid black; padding: 5px;">'.$required.'</td></tr><tr><td style="border: 1px solid black; padding: 5px;">Price (USD)</td><td style="border: 1px solid black; padding: 5px;">'.$price.'</td></tr><tr><td style="border: 1px solid black; padding: 5px;">stich</td><td style="border: 1px solid black; padding: 5px;">'.$stich.'</td></tr><tr><td style="border: 1px solid black; padding: 5px;">Additional Instructions</td><td style="border: 1px solid black; padding: 5px;">'.$ins.'</td></tr><tr><td style="border: 1px solid black; padding: 5px;">Price</td><td style="border: 1px solid black; padding: 5px;">$'.$price.'</td></tr></table>
...
$get = "SELECT * FROM release_vector WHERE orderid = $orderid";
$result3 = mysqli_query($conn,$get);
echo "<script>alert('Vector release');
     window.location.href ='pending_vector.php'</script>";
