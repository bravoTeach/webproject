...
$sql = "SELECT * FROM placequote where status = 'release'";
$result = mysqli_query($conn, $sql);
// -------------------------------
// $sql2="SELECT * FROM placequote where status = 'release' ORDER BY id DESC ";
...
?>
<div>
<h4>Total Release Quotes:  <?php echo $inquiry;  ?> </h4>
...
<td><a href="delete_quote.php?id=<?= $row["id"];?>"style="background-color:blue;">DELETE</a></td>
<!-- <td><a href="quotedetail.php?id=<?= $row["id"];?>">DETAIL</a></td> -->
<!--<td><a href="release.php?id=<?= $row["id"];?>">RELEASE</a></td>-->
