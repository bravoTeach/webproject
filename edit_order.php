...
<br>
  ...
  <input type="hidden" name="name" class="user-passbox4" value="<?php echo "(OR: 1".$id.")".$name;?>" id="name" size="51" >
...
if (empty($_POST['ins'])) {
    ...
    // $urgent = $_POST['urgent'];
        ...
        if(!empty($image1)){
            ...
            $uploadOk = 0;
                ...
                $sql = "INSERT INTO placeorder (name,required,height,width,fabric,placement,color,ins,image,user,email,status) VALUES ('$name1','$required1','$height1','$width1','$fabric1','$placement1','$color1','$ins1','$image1','$user1','$email1','$status1')";
                if(mysqli_query($conn, $sql)){
                
                 $last_id = mysqli_insert_id($conn);
                   $update = "UPDATE placeorder SET edit = '$editf' WHERE id = '$idd'";
  if (mysqli_query($conn, $update)) {
    $is_insert = true;
        ...
        $mail->Subject = "Revision Requested (OrderID# OR-1$last_id)($name1) ";
    ...
    <p>Best Regards,<br>Team<br>Tel: (915) 266-4883<br>Email: jibranahmed1752@gmail.com<br>g.com<br>URL: www.com</p>";
    ...
    $mail->addAttachment($img1);
        ...
        echo "<meta http-equiv='refresh' content='0; URL=cus_order_records.php'>";
              ...
              $sql = "INSERT INTO placeorder (name,required,height,width,fabric,placement,color,ins,user,email,status) VALUES ('$name1','$required1','$height1','$width1','$fabric1','$placement1','$color1','$ins1','$user1','$email1','$status1')";
                if(mysqli_query($conn, $sql)){
