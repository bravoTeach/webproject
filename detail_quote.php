...
<div class="d-grid gap-2 col-7 mx-auto butn" >
        ...
        <div class="col-lg-8">
            ...
            <table class="w3-table w3-striped w3-bordered w3-border w3-hoverable w3-white dl_btn">
                <h1>Quote Details</h1>
                <div class="edit">
    <a href="edit_quote.php?id=<?= $id;?>">Edit</a>
    <a href="convert_order.php?id=<?= $id;?>">Convert to Order</a>
    <br><br>
        </div>
    <tr>
            <th>Status</th>
...
<tr>
            ...
            <th>File1:</th>
            <td><a href="download_quote1.php?id=<?= $id;?>"><?php echo $imageURL; ?></a> </td>
...
if(isset($_GET['id']) AND intval($_GET['id']) > 0){
    ...
    if (mysqli_num_rows($result1) > 0) {
       ...
       while($row1 = mysqli_fetch_assoc($result1)) {
        ...
        // echo $id1; 
        ?>
        <a href="download_quote.php?id=<?= $row1["id"];?>"><?php echo $image; ?></a> 
        </td>
       </tr>
