...
$email = $_SESSION['cus_email'];
    ...
    $sql = "SELECT * FROM placeorder WHERE email = '$email' ORDER BY id DESC" ;
...
<!--<td><a href="edit_order.php?id=<?= $row["id"];?>">Edit</a></td>-->
<td><a href="detail_order.php?id=<?= $row["id"];?>">Detail</a></td>
