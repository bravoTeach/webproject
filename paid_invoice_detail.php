...
while($row = mysqli_fetch_assoc($result)) {
    $html .= '<tr>
      ...
      <td style="border: 1px solid #ccc; padding: 5px;">$'.$totalAAmount.'</td>
    </tr></tbody></table>';
...
if (mysqli_num_rows($result1) > 0) {  
    while($row1 = mysqli_fetch_assoc($result1)) {
     ...
     echo "Invoice ID: 0".$invoiceid."<br>"."<br>";
...
<?php
  ...
  <div class="row">
    ...
    <!-- <form action='https://www.2checkout.com/checkout/purchase' method='post' target='_blank'>
        ...
        <input type="hidden" name="li_0_name" value="Product:">
        <input type="hidden" name="li_0_price" value='<?=$totalamount?>'>
        <input type="hidden" name="li_0_quantity" value="1">
        <input type="hidden" name="currency_code" value="USD">
        <input type="hidden" name="x_receipt_link_url" value="https://dashboard.selectdigitizing.com/index.php">
