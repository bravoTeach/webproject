...
VALUES('$name','$company','$phone','$email','$user','$pass','$ref')";
    ...
    $mail = new PHPMailer(true);
        ...
        $mail->Subject = 'Thanks for Registration at com';
    //   $mail->Body = "Thank you for registering with Select Digitizing.";
      $mail->Body = "<p>Dear ".$name."</p>
      <p>Thank you for registering with  Our goal is to keep you thrilled with our quality, services, and prices.</p>
    <p>User Name: ".$user."</p>
    <p>Password: ".$pass."</p>
    ...
    <p>Best Regards,<br>Team <br>Tel: (915) 266-4883<br>Email: jibranahmed1752@gmail.com<br>.com<br>URL: www..com</p>";
