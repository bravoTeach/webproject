...
<br>
    <section class="midcontent">
        ...
        <div class="col-lg-8">
            <div class="row">
            <form action="edit_quote.php" method="POST" enctype="multipart/form-data">
  <!-- Name input -->
  <div class="form-outline ">
  <tr>
        <td height="35" class="form_left_text"> Order Name / PO: </td>
        <td height="35" class="form_left_text"> <?php echo $name;?> </td>
  <input type="hidden" name="name" class="user-passbox4" value="<?php echo "(QU: 1".$id.")".$name;?>" id="name" size="51" >
...
if (empty($_POST['ins'])) {
    ...
    // $urgent = $_POST['urgent'];
        ...
        if(!empty($image1)){
            ...
            $uploadOk = 0;
                ...
                $sql = "INSERT INTO placequote (name,required,height,width,fabric,placement,color,ins,image,user,email,status) VALUES ('$name1','$required1','$height1','$width1','$fabric1','$placement1','$color1','$ins1','$image1','$user1','$email1','$status1')";
                if(mysqli_query($conn, $sql)){
                
                 $last_id = mysqli_insert_id($conn);
                   $update = "UPDATE placequote SET edit = '$editf' WHERE id = '$idd'";
  if (mysqli_query($conn, $update)) {
    $is_insert = true;
        ...
        $mail->Subject = "Revision Requested (OrderID# QU-1$last_id)($name1) ";
    ...
    <p>Best Regards,<br>Team <br>Tel: (915) 266-4883<br>Email: owbkskfafhxfglal@gmail.com<br>order@.com<br>URL: www..com</p>";
    ...
    $mail->addAttachment($img1);
        ...
        echo "<meta http-equiv='refresh' content='0; URL=cus_quote_records.php'>";
              ...
              $sql = "INSERT INTO placequote (name,required,height,width,fabric,placement,color,ins,user,email,status) VALUES ('$name1','$required1','$height1','$width1','$fabric1','$placement1','$color1','$ins1','$user1','$email1','$status1')";
                if(mysqli_query($conn, $sql)){
  ...
  if (mysqli_query($conn, $update)) {
    $is_insert = true;
                ...
                $mail->setFrom('jibranahmed1752@gmail.com','jibraan ahmed');
                $mail->addAddress($email1);
                $mail->addAddress('jibranahmed1752@gmail.com');
